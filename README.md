...
- [formulaic](https://github.com/ceejbot/formulaic) - generate Homebrew tap formulas for Rust crates, optionally with a GH cli download strategy for private repos
...
- [thematic](https://github.com/ceejbot/thematic) - a not-quite-finished (but still useful) VCCode ⇔ Zed color & icon theme converter
